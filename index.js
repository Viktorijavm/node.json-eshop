...
(async () => {
    ...
    const revenue = (profit(goodsInfo) + futureProfit(goodsInfo)).toFixed(2);
    ...
    console.log(`- galimu pardavimu: ${profit(goodsInfo)} ${currency}`);
    console.log(`- maksimalus galima parduotuves apyvarta: ${(profit(goodsInfo) + futureProfit(goodsInfo)).toFixed(2)} ${currency}`);
})();